...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['TO THE MOST CHARMING AND SUPPORTIVE SISTER EVER', "\n", 'HAPPY BIRTHDAY DEAR ', config.name, "\n", 'MAY YOU GET ALL THE HAPPINESS AND SUCCESS IN THE WORLD AND LIVE LONG!', "\n", "\t", '- CHOTE'],
      charSize: 20,
      charSpacing: 20,
      lineHeight: 40,
